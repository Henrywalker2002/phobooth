...
export default function VerifyStudio() {
  ...
  const handleSubmitVerify = (e) => {
    ...
    formData.append("front_ID_card", frontIdCard.avt_file, frontIdCard.avt_file.name);
    formData.append("back_ID_card", backIdCard.avt_file, backIdCard.avt_file.name);
      ...
      >
        ...
        <div className="justify-center pl-5 py-3 rounded-lg items-start">
          ...
          <Grid container spacing={2} style={{marginTop: "10px"}}>
            <Grid item xs={6}>
              <div className="text-zinc-900 text-sm leading-5">Mặt trước của CMND/CCCD *</div>
              <VerifyUploadImage image={frontIdCard} setImage={setFontIdCard}/>
            </Grid>
            <Grid item xs={6}>
              <div className="text-zinc-900 text-sm leading-5">Mặt sau của CMND/CCCD *</div>
              <VerifyUploadImage image={backIdCard} setImage={setBackIdCard}/>
            </Grid>
          </Grid>
          <div className="text-zinc-900 text-sm leading-5 mt-3">Giấy phép kinh doanh/Chứng minh đăng kí doanh nghiệp *</div>
          <Button
            component="label"
            variant="outlined"
            sx={{
