...
class ItemServicesViewset(CustomModelViewSetBase):
    ...
    serializer_class = {"default": ItemServicesSerializer, "retrieve": ItemDetailSerializer, "list": ItemDetailSerializer}
    permission_classes = [ItemPermission]
    
    
    def get_queryset(self):
        return super().get_queryset().filter(type= ItemTypeChoices.SERVICE, studio = self.request.user.studio)
